function getRandomIntInclusive(min, max) {
  ...
  let betCells = Array.from(document.querySelectorAll('.bjNewBet'));
  ...
  function bjTotal() {
    ...
    for (let i = 0; i < 10; i++) {
      ...
      newResultRow.innerHTML = `<td></td><td></td><td></td>`;
  ...
  function fetchBlackjackData() {
    ...
    var newBets = Array.from(document.querySelectorAll('.bjNewBet'));
  
    newBets[0].classList.add('newBetActive');
